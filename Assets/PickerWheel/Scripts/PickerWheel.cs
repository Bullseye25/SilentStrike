...
namespace EasyUI.PickerWheelUI {
   ...
   public class PickerWheel : MonoBehaviour {
      ...
      [Space]
      [Header("UI Picker wheel pieces:")]
      public UIPiece[] wheelPiecesUi;
        [Space]
        [Header("UI Picker wheel pieces:")]
        public bool isAutoGeneratePieces;
        // Events
      ...
      private void Start () {
         ...
         halfPieceAngleWithPaddings = halfPieceAngle - (halfPieceAngle / 4f) ;
            ...
            else
            {
                ...
                {
                    wheelPiecesUi[i].Icon.sprite = wheelPieces[i].Icon;
                    wheelPiecesUi[i].labelText.text = wheelPieces[i].Label;
                    wheelPiecesUi[i].amountText.text = wheelPieces[i].Amount.ToString();
