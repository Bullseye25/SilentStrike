...
//! \cond
	...
	private void BasicConstructor()
		...
		this.axes.list.Add(AxisConfig.CreateSignedAnalog("Horizontal", KeyCode.None, KeyCode.None));
		this.axes.list.Add(AxisConfig.CreateSignedAnalog("Vertical", KeyCode.None, KeyCode.None));
