...
public class InputControl : MonoBehaviour {
	...
	void Update () {
		...
		if(FPSPlayerComponent && !FPSPlayerComponent.restarting){
			...
			// if(MConstants.AutoMove) //hdr
			// 	moveInput = new Vector2(0,0.5f);
			...
			else
			{
				...
				{
					// zoomHold = false;	//shifted zoom from button to slider
				}
			}
			...
			// sprintHold = ControlFreak2.CF2Input.GetButton("Sprint"); hdr
