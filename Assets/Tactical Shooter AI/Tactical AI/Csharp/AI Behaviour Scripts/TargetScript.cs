...
namespace TacticalAI
{
    public class TargetScript : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            //    if (myTeamID==1)
            //    {
            //       NoticeATarget(ControllerScript.currentController.playerTarget);

            //       // myAIBaseScript.SetMyTarget(ControllerScript.currentController.playerTarget.transform, ControllerScript.currentController.playerTarget.targetScript.myLOSTarget);
            ...
            if (myAIBaseScript && myAIBaseScript.myIdleBehaviour!= BaseScript.IdleBehaviour.MoveToTransform)
            {
                StartAttack();
        ...
        {
            if (myAIBaseScript && myAIBaseScript.myAIType!=BaseScript.AIType.Idle)
            {
                if (myTeamID == 1)
                {
                    NoticeATarget(ControllerScript.currentController.playerTarget);
