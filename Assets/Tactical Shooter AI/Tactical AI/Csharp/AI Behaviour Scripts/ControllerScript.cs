...
namespace TacticalAI
{
    public class ControllerScript : MonoBehaviour
    {
        ...
        public List<AttackPositions> tempList;
        ...
        public void SetAttackPositions(List<AttackPositions> pos)
        {
            positionsList = pos;
            tempList = new List<AttackPositions>(positionsList);

        }
        public AttackPositions GetAttackPosition()
        {
            ...
            if (tempList.Count<1)
            {
              ...
              AttackPositions attack = tempList[Random.Range(0, tempList.Count)];
            tempList.Remove(attack);
            return attack;
        }

        public void ReturnAttackPostion(AttackPositions attack)
        {
            tempList.Add(attack);
        }
        public void StartTauntSounds()
        {
            StartCoroutine("PlayTauntSounds");
        }
        public void PlaySound(AudioClip audioClip)
        {
            audioSource.PlayOneShot(audioClip);
        }
        public void StopTauntSounds()
        {
            StopCoroutine("PlayTauntSounds");
           // Debug.Log("stop ");

        }
        IEnumerator PlayTauntSounds()
        {
